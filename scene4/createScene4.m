...
%     humanCells = resizeChild(humanCells, bgHeight, bgWidth, childToParentRatio);
    ...
    [merged1, lastX, lastY] = mergeCellsWithTranslation(minion1, bgCells, middleX-xBuffer, middleY, middleX-4*xBuffer*xScale, middleY+yBuffer*yScale, useGaussian);
    [merged2, lastX, lastY] = mergeCellsWithTranslation(minion2, merged1, middleX+xBuffer, middleY, middleX+3*xBuffer*xScale, middleY+yBuffer*yScale, useGaussian);
    [merged3, lastX, lastY] = mergeCellsWithTranslation(minion3, merged2, middleX-xBuffer, middleY+yBuffer, middleX-4*xBuffer*xScale, middleY+3*yBuffer*yScale, useGaussian);
    [merged4, lastX, lastY] = mergeCellsWithTranslation(minion4, merged3, middleX+xBuffer, middleY+yBuffer, middleX+4*xBuffer*xScale, middleY+3*yBuffer*yScale, useGaussian);
